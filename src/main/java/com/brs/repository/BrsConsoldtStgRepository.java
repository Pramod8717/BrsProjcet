...
//	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='N' and VOUCHERDATE = TO_DATE('04-07-22','DD-MM-YY') and ROWNUM <= 1", nativeQuery = true)
	...
	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='N' and BANK_ACCOUNT_NO = ? AND VOUCHERDATE = str_to_date(?, current_date - 48,'%dd-%mm-%YY') and  LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsConsoldtStgData(String bankAccountNo, String voucherDate);

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='N' and BANK_ACCOUNT_NO = ?  and  LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsConsoldtStgData(String bankAccountNo);

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='N' AND VOUCHERDATE = str_to_date(?, current_date - 48,'%dd-%mm-%YY') and  LIMIT 1", nativeQuery = true)
...
//	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG_1 where  process_flag='N' and BANK_ACCOUNT_NO = ? AND VOUCHERDATE = TO_DATE(?, 'DD-MM-YY') ", nativeQuery = true)
	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='N' and BANK_ACCOUNT_NO = ? AND VOUCHERDATE = str_to_date(?, current_date - 48,'%dd-%mm-%YY') ", nativeQuery = true)
...
//			+ "select * from UAT_XXCD_BRS_CONSOLDT_STG_1 where status='Unreconciled' and process_flag='Y' and UNIQUE_REFERENCE = ? AND BANK_ACCOUNT_NO = ?", nativeQuery = true)
	...
	List<BrsConsoldtStg> getBrsRecords(String uniqueRefNo, String bankAccountNo, String uniqueRefNo1,
...
//	List<BrsConsoldtStg> getBrsUnreconRecords(String uniqueRefNo,String bankAccountNo,String uniqueRefNo1,String bankAccountNo1);
	...
	List<BrsConsoldtStg> getBrsUnreconRecords(String uniqueRefNo, String bankAccountNo, String uniqueRefNo1,
			String bankAccountNo1);
	...
	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='R' and status='Unreconciled' and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY') AND  str_to_date(?, current_date - 48,'%dd-%mm-%YY'))  LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsUnreconRecords();

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='R' and status='Unreconciled' and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY') AND str_to_date(?, current_date - 48,'%dd-%mm-%YY') and  LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsUnreconRecords3(String date, String date1);

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='R' and status='Unreconciled' AND BANK_ACCOUNT_NO = ?  and LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsUnreconRecords1(String bankAccountNo);

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where process_flag='R' and status='Unreconciled' AND BANK_ACCOUNT_NO = ?  and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY') AND str_to_date(?, current_date - 48,'%dd-%mm-%YY') LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsUnreconRecords2(String bankAccountNo, String date, String date1);

	@Transactional
	@Modifying
	@Query(value = "update UAT_XXCD_BRS_CONSOLDT_STG set process_flag=? where status='Unreconciled' and process_flag='Y' and VOUCHERDATE BETWEEN TRUNC(str_to_date(current_date - 48,'%dd-%mm-%YY'), 'MM') AND  str_to_date(current_date - 48,'%dd-%mm-%YY')) and unique_reference is not null and cheq_id is not null", nativeQuery = true)
	void updateStatusOfUnreconciledRecord(String status);

	@Transactional
	@Modifying
	@Query(value = "update UAT_XXCD_BRS_CONSOLDT_STG set process_flag=? where status='Unreconciled' and process_flag='Y' and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY') AND str_to_date(?, current_date - 48,'%dd-%mm-%YY') and unique_reference is not null and cheq_id is not null", nativeQuery = true)
	void updateStatusOfUnreconciledRecord(String status, String date, String date1);

	// In user if only bank account is used 2nd
	@Transactional
	@Modifying
	@Query(value = "update UAT_XXCD_BRS_CONSOLDT_STG set process_flag=? where status='Unreconciled' and process_flag='Y' AND BANK_ACCOUNT_NO = ? and VOUCHERDATE BETWEEN TRUNC(str_to_date(current_date - 48,'%dd-%mm-%YY') AND str_to_date(current_date - 48,'%dd-%mm-%YY')) and unique_reference is not null and cheq_id is not null", nativeQuery = true)
	...
	@Transactional
	@Modifying
	@Query(value = "update UAT_XXCD_BRS_CONSOLDT_STG set process_flag=? where status='Unreconciled' and process_flag='Y' AND BANK_ACCOUNT_NO = ? and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY'), 'MM') AND str_to_date(?, current_date - 48,'%dd-%mm-%YY') and unique_reference is not null and cheq_id is not null", nativeQuery = true)
...
//	
	...
	@Transactional
	@Modifying
	@Query(value = "update UAT_XXCD_BRS_CONSOLDT_STG set process_flag='Y', status='Unreconciled', ERROR_MESG= ? where BANK_ACCOUNT_NO = ? and VOUCHERDATE = str_to_date(?, current_date - 48,'%dd-%mm-%YY') and process_flag='N' ", nativeQuery = true)
...
//		
	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where  BANK_ACCOUNT_NO = ? and cheq_id  = ? and  LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsRecordsWithNoUnqRef(String bankAccNum, Long cheqId);

	@Query(value = "select bank_account_no,cheq_id from UAT_XXCD_BRS_CONSOLDT_STG where unique_reference is null and cheq_id is not null and process_flag IN ('N','R') and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY')) AND  str_to_date(?, current_date - 48,'%dd-%mm-%YY')) group by bank_account_no,cheq_id order by bank_account_no,cheq_id", nativeQuery = true)
	List<UpdateUnqRef> getBrsRecordsWithNoUnqRefSummary();

	@Query(value = "select bank_account_no,cheq_id from UAT_XXCD_BRS_CONSOLDT_STG where unique_reference is null and cheq_id is not null  and process_flag IN ('N','R') and BANK_ACCOUNT_NO = ? and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY') AND str_to_date(?, current_date - 48,'%dd-%mm-%YY') group by bank_account_no,cheq_id order by bank_account_no,cheq_id", nativeQuery = true)
	List<UpdateUnqRef> getBrsRecordsWithNoUnqRefSummary(String bankAccNum, String date, String date1);

	// Created
	@Query(value = "select bank_account_no,voucherdate,process_flag,status,error_mesg from UAT_XXCD_BRS_CONSOLDT_STG", nativeQuery = true)
	List<BatchStatusInterf> getStatusofJob();

	// new Queary from Pramod
//	
//	@Query(value = "select bank_account_no,voucherdate,process_flag,status,error_mesg from UAT_XXCD_BRS_CONSOLDT_STG where bank_account_no= ? and voucherdate= ? LIMIT 1", nativeQuery = true)
//	List<BatchStatusInterf> getStatusofJob1(String bacnkAccNum,String voucherdate);
//	

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where bank_account_no= ? and voucherdate= ?", nativeQuery = true)
	List<BrsConsoldtStg> getStatusofJob1(String bankAccountNo, String voucherdate);

	
	// For Status----
	@Query(value = "select cheque_status from UAT_XXCD_BRS_CONSOLDT_STG where bank_account_no= ? and voucherdate= ?", nativeQuery = true)
	List<BrsConsoldtStg> getStatusofJob2(String bankAccountNo, String voucherdate);

	
	
	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where  ID = ? LIMIT 1", nativeQuery = true)
	BrsConsoldtStg getBrsRecordsById(Long id);

	@Query(value = "select Id from UAT_XXCD_BRS_CONSOLDT_STG where bank_account_no is null and process_flag IN ('N','R') and VOUCHERDATE BETWEEN TRUNC(str_to_date(current_date - 48,'%dd-%mm-%YY')), 'MM') AND str_to_date(current_date - 48,'%dd-%mm-%YY')) "
			+ "Union all"
			+ "select Id from UAT_XXCD_BRS_CONSOLDT_STG where unique_reference is null and cheq_id is null and process_flag IN ('N','R') and VOUCHERDATE BETWEEN TRUNC(str_to_date(current_date - 48,'%dd-%mm-%YY')), 'MM') AND str_to_date(current_date - 48,'%dd-%mm-%YY')) ", nativeQuery = true)
	List<Long> getBrsRecordsWithNoBankDetails();

	@Query(value = "select Id from UAT_XXCD_BRS_CONSOLDT_STG where bank_account_no is null and process_flag IN ('N','R') and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY')) AND str_to_date(?, current_date - 48,'%dd-%mm-%YY') "
			+ "Union all"
			+ "select Id from UAT_XXCD_BRS_CONSOLDT_STG where unique_reference is null and cheq_id is null and process_flag IN ('N','R') and bank_account_no = ? and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY')) AND str_to_date(?, current_date - 48,'%dd-%mm-%YY')) ", nativeQuery = true)
	List<Long> getBrsRecordsWithNoBankDetails(String date, String date1, String bankAccNum, String date3, String date4);

	@Query(value = "select * from UAT_XXCD_BRS_CONSOLDT_STG where  bank_account_no = ? and unique_reference = ?  LIMIT 1", nativeQuery = true)
...
//	@Query(value = "select * from uat_xxcd_brs_consoldt_stg where bank_account_no is not null and unique_reference is not null and process_flag = ? and VOUCHERDATE = TO_DATE(to_char(sysdate-48)) group by bank_account_no,unique_reference order by bank_account_no,unique_reference ", nativeQuery = true)
	@Query(value = "select * from uat_xxcd_brs_consoldt_stg where bank_account_no is not null and unique_reference is not null and process_flag = ? and VOUCHERDATE = str_to_date(?, current_date - 48,'%dd-%mm-%YY'))  ", nativeQuery = true)
...
//	@Query(value = "select * from uat_xxcd_brs_consoldt_stg where bank_account_no is not null and unique_reference is not null and process_flag = ? and bank_account_no = ? and VOUCHERDATE = TO_DATE(?, 'DD-MM-YY')  group by bank_account_no,unique_reference order by bank_account_no,unique_reference ", nativeQuery = true)
	@Query(value = "select * from uat_xxcd_brs_consoldt_stg where bank_account_no is not null and unique_reference is not null and process_flag = ? and bank_account_no = ? and VOUCHERDATE = str_to_date(?, current_date - 48,'%dd-%mm-%YY')) ", nativeQuery = true)
	List<BrsConsoldtStg> getBrsRecordsWithBnkNumAndUnqRefSummary(String status, String bankAccNum, String date);

	@Query(value = "select bank_account_no,unique_reference from uat_xxcd_brs_consoldt_stg where bank_account_no is not null and unique_reference is not null and process_flag = ? and VOUCHERDATE BETWEEN TRUNC(str_to_date(current_date - 48,'%dd-%mm-%YY')) AND str_to_date(current_date - 48,'%dd-%mm-%YY'))  group by bank_account_no,unique_reference order by bank_account_no,unique_reference ", nativeQuery = true)
	List<BrsInfo> getBrsUnreconciledRecordsWithBnkNumAndUnqRefSummary(String status);

	@Query(value = "select bank_account_no,unique_reference from uat_xxcd_brs_consoldt_stg where bank_account_no is not null and unique_reference is not null and process_flag = ? and bank_account_no = ? and VOUCHERDATE BETWEEN TRUNC(str_to_date(?, current_date - 48,'%dd-%mm-%YY')) AND str_to_date(?, current_date - 48,'%dd-%mm-%YY')) group by bank_account_no,unique_reference order by bank_account_no,unique_reference ", nativeQuery = true)
	List<BrsInfo> getBrsUnreconciledRecordsWithBnkNumAndUnqRefSummary(String status, String bankAccNum, String date,
			String date1);

	@Query(value = "select count(*) as count from UAT_XXCD_BRS_CONSOLDT_STG where BANK_ACCOUNT_NO=? and voucherdate =str_to_date(?, current_date - 48,'%dd-%mm-%YY')) and (process_flag is null or process_flag IN('N','R') or (process_flag ='Y' and status='Unreconciled')) ", nativeQuery = true)
	Long getCountOfInProcessRecord(String bankAccNum, String date);

//	List<BatchStatusInterf> getdetailsAll();
	
	
	
	// For cheque_status ::::::::
	@Query(value = "select cheque_status from uat_xxcd_brs_consoldt_stg where bank_account_no= ? and voucherdate= ?  LIMIT 1" , nativeQuery = true)
