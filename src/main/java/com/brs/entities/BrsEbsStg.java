...
@Entity
//@Table(name = "UAT_XXCD_BRS_EBS_STG_1")
@Table(name = "UAT_XXCD_BRS_EBS_STG")
//@Getter
//@Setter
//@NoArgsConstructor
//@AllArgsConstructor
//@ToString
public class BrsEbsStg {
...
//	private String lastUpdateBy;
	...
	public BrsEbsStg(Long id, String bankAcNo, String system, String voucherId, Date voucherDate, Date valueDate,
			...
			String unmatchRef, String processStatus, String status, String errorMsg, String statementNo, long lineNo,
			String txnType, Date txnDate, String bankTrxNum, Date effectiveDate, String txnText, String customerText,
			String bankAccountText, Long lineId, Long stgIntProcessId, Long loaderProcessId, Date creationDate,
			Short createdBy, Date lastUpdateDate, Short lastUpdatedBy, String stmtType, Long jeBatchId,
			String periodName, Long jeHeaderId, Long jeLineNum, Long chartOfAccountId, String funtionalCurrencyCode,
	...
	public String toString() {
		return "BrsEbsStg [id=" + id + ", bankAcNo=" + bankAcNo + ", system=" + system + ", voucherId=" + voucherId
				...
				+ uniqueRef + ", matchRef=" + matchRef + ", unmatchRef=" + unmatchRef + ", processStatus="
				+ processStatus + ", status=" + status + ", errorMsg=" + errorMsg + ", statementNo=" + statementNo
				+ ", lineNo=" + lineNo + ", txnType=" + txnType + ", txnDate=" + txnDate + ", bankTrxNum=" + bankTrxNum
				+ ", effectiveDate=" + effectiveDate + ", txnText=" + txnText + ", customerText=" + customerText
				+ ", bankAccountText=" + bankAccountText + ", lineId=" + lineId + ", stgIntProcessId=" + stgIntProcessId
				+ ", loaderProcessId=" + loaderProcessId + ", creationDate=" + creationDate + ", createdBy=" + createdBy
				+ ", lastUpdateDate=" + lastUpdateDate + ", lastUpdatedBy=" + lastUpdatedBy + ", stmtType=" + stmtType
				+ ", jeBatchId=" + jeBatchId + ", periodName=" + periodName + ", jeHeaderId=" + jeHeaderId
				+ ", jeLineNum=" + jeLineNum + ", chartOfAccountId=" + chartOfAccountId + ", funtionalCurrencyCode="
				+ funtionalCurrencyCode + ", codeCombinationId=" + codeCombinationId + "]";
	}
