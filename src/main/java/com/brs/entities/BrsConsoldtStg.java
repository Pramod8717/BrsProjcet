...
@Entity
//@Table(name = "UAT_XXCD_BRS_CONSOLDT_STG_1")
@Table(name = "UAT_XXCD_BRS_CONSOLDT_STG")
//@Getter
//@Setter
//@NoArgsConstructor
//@AllArgsConstructor
//@ToString
public class BrsConsoldtStg {
...
//	private String unmatchRef;
	...
	private Short lastUpdateBy;

	public BrsConsoldtStg(Long id, String bankAcNo, String system, String voucherId, Date voucherDate, Date valueDate,
			...
			Date realizationDate, String processFlag, String sourceSystem, String uniqueRef, String status,
			String errorMsg, Long jeBatchId, String periodName, Long jeHeaderId, Long jeLineNum, Long chartOfAccountId,
			String funtionalCurrencyCode, Long codeCombinationId, Date creationDate, Short createdBy,
			Date lastUpdateDate, Short lastUpdateBy) {
		super();
		this.id = id;
	...
	public Short getLastUpdateBy() {
		return lastUpdateBy;
	}

	public void setLastUpdateBy(Short lastUpdateBy) {
		this.lastUpdateBy = lastUpdateBy;
	}

	@Override
	public String toString() {
		return "BrsConsoldtStg [id=" + id + ", bankAcNo=" + bankAcNo + ", system=" + system + ", voucherId=" + voucherId
				...
				+ uniqueRef + ", status=" + status + ", errorMsg=" + errorMsg + ", jeBatchId=" + jeBatchId
				...
				+ ", codeCombinationId=" + codeCombinationId + ", creationDate=" + creationDate + ", createdBy="
				+ createdBy + ", lastUpdateDate=" + lastUpdateDate + ", lastUpdateBy=" + lastUpdateBy + "]";
	}
